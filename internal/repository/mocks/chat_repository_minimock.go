...
//go:generate minimock -i github.com/ybgr111/chat-server/internal/repository.ChatRepository -o chat_repository_minimock.go -n ChatRepositoryMock -p mocks
...
type ChatRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, chat *chatModel.Chat) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, chat *chatModel.Chat)
	...
	funcSendMessage          func(ctx context.Context, message *chatModel.Message) (err error)
	inspectFuncSendMessage   func(ctx context.Context, message *chatModel.Message)
...
func (mmCreate *mChatRepositoryMockCreate) Expect(ctx context.Context, chat *chatModel.Chat) *mChatRepositoryMockCreate {
...
func (mmCreate *mChatRepositoryMockCreate) Inspect(f func(ctx context.Context, chat *chatModel.Chat)) *mChatRepositoryMockCreate {
...
func (mmCreate *mChatRepositoryMockCreate) Set(f func(ctx context.Context, chat *chatModel.Chat) (i1 int64, err error)) *ChatRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatRepositoryMockCreate) When(ctx context.Context, chat *chatModel.Chat) *ChatRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
...
func (mmSendMessage *mChatRepositoryMockSendMessage) Expect(ctx context.Context, message *chatModel.Message) *mChatRepositoryMockSendMessage {
...
func (mmSendMessage *mChatRepositoryMockSendMessage) Inspect(f func(ctx context.Context, message *chatModel.Message)) *mChatRepositoryMockSendMessage {
...
func (mmSendMessage *mChatRepositoryMockSendMessage) Set(f func(ctx context.Context, message *chatModel.Message) (err error)) *ChatRepositoryMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mChatRepositoryMockSendMessage) When(ctx context.Context, message *chatModel.Message) *ChatRepositoryMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatRepositoryMock.SendMessage mock is already set by Set")
	}
